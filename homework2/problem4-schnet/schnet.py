...
class SchNet(torch.nn.Module):
    ...
    def forward(self, z, pos, batch=None):
        ...
        h = #TODO: compute initial node representations
        edge_index = radius_graph(pos, r=self.cutoff, batch=batch, max_num_neighbors=self.max_num_neighbors)
        
        edge_weight = #TODO: compute pairwise distances
        edge_attr = #TODO: compute radial basis expansion of pairwise distances
        ...
        energy = #TODO: compute global energies per molecule

        forces = #TODO: compute forces
...
class CFConv(torch.nn.Module):
    ...
    def forward(self, h, edge_index, edge_weight, edge_attr):
        h = self.lin1(h)
        c = #TODO: transform edge weights to [0,1]
        W = #TODO: compute filters
        h = #TODO: perform graph convolution
        h = self.lin2(h)
        return h
